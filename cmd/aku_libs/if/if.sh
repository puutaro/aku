	...
	case "${HELP}" in
		...
		*)
			awk 'BEGIN {
				...
				print ""
				print "```sh.sh"
				print "echo \x22aa    bb   cc    #dd\x22 | aku if \x22.*\x22 \x22echo @[1}\x22 -f \x222\x22"
				print "```"
				print ""
				print "- Ex multiple field"
				print ""
				print "```sh.sh"
				print "echo \x22aa    bb   cc    #dd\x22 | aku if \x22.*\x22 \x22echo @[1}\x22 -f \x221\x22 -f \x223-4\x22"
				print "```"
				print ""
				print "- Ex multiple field by end range"
				print ""
				print "```sh.sh"
				print "echo \x22aa    bb   cc    #dd\x22 | aku if -f \x22.*\x22 \x22echo @[1}\x22 \x221\x22 -f \x22-4\x22"
				print "```"
				print ""
				print "- Ex multiple field by end range"
				print ""
				print "```sh.sh"
				print "echo \x22aa    bb   cc    #dd\x22 | aku if \x22.*\x22 \x22echo @[1}\x22 -f \x221\x22 -f \x222-\x22"
				print "```"
				print ""
				print "#### --row-num|-r"
				print ""
