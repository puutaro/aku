	...
	case "${HELP}" in
		...
		*)
			awk 'BEGIN {
				...
				print ""
				print "```.sh.sh"
				print "echo \x22aa\nbb\x22 | aku sd \x22(a)\x22 \x22PREFIX\\\\1SUFFIX\x22"
				print ""
				print "->"
				...
				print ""
				print "```.sh.sh"
				print "aku sd \x22aa\x22 -i \x22aa\nbb\x22"
				print "->"
				print "\nbb"
				print "```"
				print ""
				...
				print ""
				print "```.sh.sh"
				print "echo \x22aaA\nbBb\nccC\nDdd\x22 | aku sd \x22[a-z]\x22 -r -2"
				print "->"
				print "A\nB\nccC\nDdd"
				print "```"
				print ""
				...
				print ""
				print "```.sh.sh"
				print "echo \x22aaA\nbBb\nccC\nDdd\x22 | aku sd \x22[a-z]\x22 -r 2-4"
				print "->"
				print "aaA\nB\nC\nD"
				print "```"
				print ""
				...
				print ""
				print "```.sh.sh"
				print "echo \x22aaA\nbBb\nccC\nDdd\x22 | aku sd \x22[a-z]\x22 -r 1 -r 3-4"
				print "->"
				print "A\nbBb\ncC\nD"
				print "```"
				print ""
